...
public class PTRecipes {
    ...
    public static final RegistryEntry<RabbiRecipeSerializer<InfuserRecipe>> INFUSER_RECIPE_SERIALIZER = RECIPE_SERIALIZERS.register("infuser", InfuserRecipe.Serializer::new);
    public static final RegistryEntry<RabbiRecipeType<InfuserRecipe>> INFUSER_RECIPE_TYPE = RECIPE_TYPES.register("infuser", () -> new RabbiRecipeType<>() {
        @Override
