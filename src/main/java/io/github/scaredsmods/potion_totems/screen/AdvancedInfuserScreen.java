...
public class AdvancedInfuserScreen extends AbstractContainerScreen<AdvancedInfuserMenu> {
    ...
    private static final ResourceLocation GUI_TEXTURE = PotionTotemsMain.id("textures/gui/advanced_infuser/advanced_infuser_gui.png");
    private static final ResourceLocation ARROW_TEXTURE = PotionTotemsMain.id("textures/gui/advanced_infuser/advanced_infuser_arrow_progress.png");
