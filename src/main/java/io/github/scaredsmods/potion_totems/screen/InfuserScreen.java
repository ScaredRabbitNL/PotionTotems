...
public class InfuserScreen extends AbstractContainerScreen<InfuserMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(PotionTotems.MOD_ID,"textures/gui/infuser/infuser_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(PotionTotems.MOD_ID,"textures/gui/arrow_progress.png");
